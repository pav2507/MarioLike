export class Ennemydist extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y) {
        ...
        this.visionBox.setSize(200, 150);
        ...
        this.shurikenDelay = 2000; // Délai entre chaque création de shuriken (2 secondes)
    ...
    animsennemi2(){
        this.anims.create({
            key: 'ennemi2-annim',
            frames: this.anims.generateFrameNumbers('ennemi2', { start: 0, end: 2 }),
            frameRate: 7,
            repeat: -1
        });
        this.play('ennemi2-annim');
    }

    createShuriken() {
        const shuriken = this.shurikenGroup.create(this.x, this.y, 'shuriken');
        shuriken.setVelocityX(this.scene.player.x > this.x ? 200 : -200); // Définit la vitesse du shuriken en fonction de la position du joueur
